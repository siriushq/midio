...
// WARNING:
//
// Expected source line number is hard coded, 19, in the
...
func TestGetSource(t *testing.T) {
	...
	// Hard coded line number, 19, in the "expectedSource" value
	expectedSource := "[namespace-lock_test.go:19:TestGetSource()]"
